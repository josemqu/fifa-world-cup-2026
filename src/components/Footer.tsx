...
export function Footer() {
  return (
    <footer className="hidden md:block fixed bottom-0 left-0 right-0 z-50 border-t border-slate-200 dark:border-slate-800 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md py-1.5 shadow-lg">
