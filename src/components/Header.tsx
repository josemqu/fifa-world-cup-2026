...
export function Header() {
  ...
  useEffect(() => {
    ...
    if (typeof window !== "undefined") {
      setIsLoggedInCookie(document.cookie.includes("is_logged_in=true"));
    }
  }, []);
        ...
        <div className="relative max-w-[1600px] mx-auto px-4 md:px-8 py-3.5 md:py-6 flex items-center justify-between gap-4">
          ...
          <div className="shrink-0">
            ...
            >
              ...
              <div>
                <div className="text-xl md:text-2xl font-extrabold tracking-tight text-slate-900 dark:text-white leading-tight">
                  Mundial{" "}
          ...
          <div className="flex items-center justify-end gap-2 shrink-0 md:w-[200px] lg:w-[300px]">
            ...
            {!mounted ? (
              ...
              isLoggedInCookie ? (
                ...
                // Logged-out ("Ingresar" button) skeleton
                <div className="w-[88px] h-9 bg-slate-200 dark:bg-slate-700 rounded-lg animate-pulse" />
              )
            ) : (
              <>
