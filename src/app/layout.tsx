...
export const metadata: Metadata = {
  ...
  title: {
    default: "World Cup 2026 - Fixture Interactivo y Simulador",
  ...
  openGraph: {
    title: "World Cup 2026 - Fixture Interactivo",
    description:
    ...
    siteName: "World Cup 2026 Simulator",
    locale: "es_ES",
    type: "website",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "World Cup 2026 Fixture Preview",
      },
    ],
  },
  twitter: {
